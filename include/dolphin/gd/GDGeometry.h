...
#define CP_REG_VCD_LO(pnMtxIdx, txMtxIdxMask, posn, norm, col0, col1) \
    ((pnMtxIdx) << 0 | (txMtxIdxMask) << 1 | (posn) << 9 | (norm) << 11 | (col0) << 13 | (col1) << 15)

#define CP_REG_VCD_HI(tex0, tex1, tex2, tex3, tex4, tex5, tex6, tex7) \
    ((tex0) << 0 | (tex1) << 2 | (tex2) << 4 | (tex3) << 6 | (tex4) << 8 | (tex5) << 10 | (tex6) << 12 | (tex7) << 14)

#define CP_REG_VAT_GRP0(posCnt, posType, posFrac, nrmCnt, nrmType, c0Cnt, c0Type, c1Cnt, c1Type, tx0Cnt, tx0Type, \
                        tx0Frac, p12, nrmIdx3)                                                                    \
    ((posCnt) << 0 | (posType) << 1 | (posFrac) << 4 | (nrmCnt) << 9 | (nrmType) << 10 | (c0Cnt) << 13 |          \
     (c0Type) << 14 | (c1Cnt) << 17 | (c1Type) << 18 | (tx0Cnt) << 21 | (tx0Type) << 22 | (tx0Frac) << 25 |       \
     (p12) << 30 | (nrmIdx3) << 31)

#define CP_REG_VAT_GRP1(tx1Cnt, tx1Type, tx1Frac, tx2Cnt, tx2Type, tx2Frac, tx3Cnt, tx3Type, tx3Frac, tx4Cnt, tx4Type, \
                        p11)                                                                                           \
    ((tx1Cnt) << 0 | (tx1Type) << 1 | (tx1Frac) << 4 | (tx2Cnt) << 9 | (tx2Type) << 10 | (tx2Frac) << 13 |             \
     (tx3Cnt) << 18 | (tx3Type) << 19 | (tx3Frac) << 22 | (tx4Cnt) << 27 | (tx4Type) << 28 | p11 << 31)

#define CP_REG_VAT_GRP2(tx4Frac, tx5Cnt, tx5Type, tx5Frac, tx6Cnt, tx6Type, tx6Frac, tx7Cnt, tx7Type, tx7Frac) \
    ((tx4Frac) << 0 | (tx5Cnt) << 5 | (tx5Type) << 6 | (tx5Frac) << 9 | (tx6Cnt) << 14 | (tx6Type) << 15 |     \
     (tx6Frac) << 18 | (tx7Cnt) << 23 | (tx7Type) << 24 | (tx7Frac) << 27)
...
#define XF_REG_INVTXSPEC(ncols, nnorms, ntexs) ((ncols) << 0 | (nnorms) << 2 | (ntexs) << 4)
...
#define BP_LP_SIZE(lineWidth, pointSize, lineOffset, pointOffset, lineHalfAspect, p5)                     \
    ((u32)(lineWidth) << 0 | (u32)(pointSize) << 8 | (u32)(lineOffset) << 16 | (u32)(pointOffset) << 19 | \
     (u32)(lineHalfAspect) << 22 | (u32)(p5) << 24)
