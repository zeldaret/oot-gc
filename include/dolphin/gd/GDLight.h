...
#define XF_REG_CHAN_CTRL(matsrc, enable, lightmask0, ambsrc, diff_fn, p5, p6, lightmask4)                          \
    ((u32)(matsrc) << 0 | (u32)(enable) << 1 | (u32)(lightmask0) << 2 | (u32)(ambsrc) << 6 | (u32)(diff_fn) << 7 | \
     (u32)(p5) << 9 | (u32)(p6) << 10 | (u32)(lightmask4) << 11)
...
void GDSetChanCtrl(GXChannelID chan, u8 enable, GXColorSrc amb_src, GXColorSrc mat_src, u32 light_mask,
...
inline static u16 __GDLightID2Offset(GXLightID id) { return __GDLightID2Index(id) * 16; }
