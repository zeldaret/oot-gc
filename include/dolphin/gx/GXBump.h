#ifndef _DOLPHIN_GX_GXBUMP_H
#define _DOLPHIN_GX_GXBUMP_H
...
void GXSetTevIndWarp(GXTevStageID tev_stage, GXIndTexStageID ind_stage, u8 signed_offset, u8 replace_mode,
