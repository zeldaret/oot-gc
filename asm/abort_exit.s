...
/* 0C8A54 800CDFF4 800D8FE0 */  lwz     r0, __aborting@sda21(r13)
...
lbl_800CE00C:
/* 0C8A6C 800CE00C 806D8FE4 */  lwz     r3, atexit_curr_func@sda21(r13)
/* 0C8A70 800CE010 3863FFFF */  addi    r3, r3, -1
/* 0C8A74 800CE014 5460103A */  slwi    r0, r3, 2
/* 0C8A78 800CE018 906D8FE4 */  stw     r3, atexit_curr_func@sda21(r13)
...
lbl_800CE02C:
/* 0C8A8C 800CE02C 800D8FE4 */  lwz     r0, atexit_curr_func@sda21(r13)
...
/* 0C8AC4 800CE064 818D8FEC */  lwz     r12, __stdio_exit@sda21(r13)
...
/* 0C8ADC 800CE07C 900D8FEC */  stw     r0, __stdio_exit@sda21(r13)
lbl_800CE080:
...
lbl_800CE08C:
/* 0C8AEC 800CE08C 806D8FE8 */  lwz     r3, __atexit_curr_func@sda21(r13)
/* 0C8AF0 800CE090 3863FFFF */  addi    r3, r3, -1
/* 0C8AF4 800CE094 5460103A */  slwi    r0, r3, 2
/* 0C8AF8 800CE098 906D8FE8 */  stw     r3, __atexit_curr_func@sda21(r13)
...
lbl_800CE0AC:
/* 0C8B0C 800CE0AC 800D8FE8 */  lwz     r0, __atexit_curr_func@sda21(r13)
...
/* 0C8B1C 800CE0BC 818D8FF0 */  lwz     r12, __console_exit@sda21(r13)
...
/* 0C8B34 800CE0D4 900D8FF0 */  stw     r0, __console_exit@sda21(r13)
lbl_800CE0D8:
