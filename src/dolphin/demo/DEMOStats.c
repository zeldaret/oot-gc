    ...
    switch (DemoStat[DemoStatIndx].stat_type) {
        case DEMO_STAT_GP0:
            if (update) {
                ...
                GXSetGPMetric((GXPerf0)DemoStat[DemoStatIndx].stat, GX_PERF1_NONE);
                GXClearGPMetric();
            }
        ...
        case DEMO_STAT_GP1:
            if (update) {
                ...
                GXSetGPMetric(GX_PERF0_NONE, (GXPerf1)DemoStat[DemoStatIndx].stat);
                GXClearGPMetric();
            }
            break;
        case DEMO_STAT_MEM:
        ...
        case DEMO_STAT_MYR:
            break;
        default:
            OSPanic("DEMOStats.c", 295, "DEMOSetStats: Unknown demo stat type\n");
            break;
    }
}
