...
char unused1[] = "Memory Card 59";
char unused2[] = "Memory Card 123";
char unused3[] = "Memory Card 251";
char unused4[] = "Memory Card 507";

#if VERSION > MQ_E
char unused5[] = "Memory Card 1019";
char unused6[] = "Memory Card 2043";
#endif

char unused7[] = "USB Adapter";
char unused8[] = "Net Card";
char unused9[] = "Artist Ether";

#if VERSION > MQ_E
char unused10[] = "Broadband Adapter";
#endif

char unused11[] = "Stream Hanger";

#if VERSION > MQ_E
char unused12[] = "IS-DOL-VIEWER";
#else
char unused12[] = "IS Viewer";
#endif
