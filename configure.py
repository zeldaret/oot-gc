...
config.libs = [
    ...
    MetroTRKLib(
        ...
        [
            ...
            Object(LinkedFor("ce-j"), "metrotrk/nubevent.c"),
            ...
            Object(LinkedFor("ce-j"), "metrotrk/serpoll.c"),
            Object(LinkedFor("ce-j"), "metrotrk/usr_put.c"),
            Object(LinkedFor("ce-j"), "metrotrk/dispatch.c"),
            Object(LinkedFor("ce-j"), "metrotrk/msghndlr.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j"), "metrotrk/support.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j"), "metrotrk/mutex_TRK.c"),
            Object(LinkedFor("ce-j"), "metrotrk/notify.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            ...
            Object(LinkedFor("ce-j"), "metrotrk/targimpl.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j"), "metrotrk/dolphin_trk.c"),
            Object(LinkedFor("ce-j"), "metrotrk/mpc_7xx_603e.c"),
            Object(LinkedFor("ce-j"), "metrotrk/main_TRK.c"),
            Object(LinkedFor("ce-j"), "metrotrk/dolphin_trk_glue.c", extra_cflags=["-enum int"]),
