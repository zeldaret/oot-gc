...
config.libs = [
    ...
    MetroTRKLib(
        "metrotrk",
        [
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/mainloop.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/nubevent.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/nubinit.c", extra_cflags=["-enum int"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/msg.c"),
            Object(NotLinked, "metrotrk/msgbuf.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/serpoll.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/usr_put.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/dispatch.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/msghndlr.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/support.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/mutex_TRK.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/notify.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/flush_cache.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/mem_TRK.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/__exception.s"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/targimpl.c", extra_cflags=["-enum int", "-inline on,noauto"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/dolphin_trk.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/mpc_7xx_603e.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/main_TRK.c"),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/dolphin_trk_glue.c", extra_cflags=["-enum int"]),
            Object(LinkedFor("ce-j", "ce-u", "ce-e", "mm-j", "mm-u", "mm-e"), "metrotrk/targcont.c"),
        ]
    ),
    RuntimeLib(
        "runtime",
