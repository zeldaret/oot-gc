...
config.libs = [
    ...
    MetroTRKLib(
        ...
        [
            ...
            Object(NotLinked, "metrotrk/support.c", extra_cflags=["-enum int"]),
            Object(LinkedFor("ce-j"), "metrotrk/mutex_TRK.c"),
            Object(NotLinked, "metrotrk/notify.c", extra_cflags=["-enum int"]),
            ...
            Object(NotLinked, "metrotrk/dolphin_trk.c", extra_cflags=["-proc gekko"]),
